...
module.exports = __toCommonJS(dist_src_exports);
var import_universal_user_agent = __nccwpck_require__(928);
var import_before_after_hook = __nccwpck_require__(73);
var import_request = __nccwpck_require__(756);
var import_graphql = __nccwpck_require__(764);
var import_auth_token = __nccwpck_require__(45);
...
var import_is_plain_object = __nccwpck_require__(84);
...
var deprecation = __nccwpck_require__(503);
var once = _interopDefault(__nccwpck_require__(341));
...
module.exports = __toCommonJS(dist_src_exports);
var import_endpoint = __nccwpck_require__(402);
var import_universal_user_agent = __nccwpck_require__(928);
...
var import_is_plain_object = __nccwpck_require__(84);
var import_node_fetch = __toESM(__nccwpck_require__(466));
var import_request_error = __nccwpck_require__(295);
...
module.exports = __toCommonJS(dist_src_exports);
var import_core = __nccwpck_require__(272);
var import_plugin_request_log = __nccwpck_require__(227);
var import_plugin_paginate_rest = __nccwpck_require__(991);
var import_plugin_rest_endpoint_methods = __nccwpck_require__(698);
...
var register = __nccwpck_require__(552);
var addHook = __nccwpck_require__(210);
var removeHook = __nccwpck_require__(353);
...
var balanced = __nccwpck_require__(639);
...
var whatwgUrl = _interopDefault(__nccwpck_require__(591));
...
let convert;
try {
	convert = (__nccwpck_require__(769).convert);
} catch (e) {}
...
var wrappy = __nccwpck_require__(961)
...
const usm = __nccwpck_require__(702);
...
const utils = __nccwpck_require__(778);
const Impl = __nccwpck_require__(425);
...
exports.URL = __nccwpck_require__(958)["interface"];
exports.serializeURL = __nccwpck_require__(702).serializeURL;
exports.serializeURLOrigin = __nccwpck_require__(702).serializeURLOrigin;
exports.basicURLParse = __nccwpck_require__(702).basicURLParse;
exports.setTheUsername = __nccwpck_require__(702).setTheUsername;
exports.setThePassword = __nccwpck_require__(702).setThePassword;
exports.serializeHost = __nccwpck_require__(702).serializeHost;
exports.serializeInteger = __nccwpck_require__(702).serializeInteger;
exports.parseURL = __nccwpck_require__(702).parseURL;
...
const tr46 = __nccwpck_require__(719);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.AST = void 0;
const brace_expressions_js_1 = __nccwpck_require__(959);
const unescape_js_1 = __nccwpck_require__(40);
const types = new Set(['!', '?', '+', '*', '@']);
...
const assert_valid_pattern_js_1 = __nccwpck_require__(822);
const ast_js_1 = __nccwpck_require__(134);
const escape_js_1 = __nccwpck_require__(151);
const unescape_js_1 = __nccwpck_require__(40);
...
var escape_js_2 = __nccwpck_require__(151);
Object.defineProperty(exports, "escape", ({ enumerable: true, get: function () { return escape_js_2.escape; } }));
var unescape_js_2 = __nccwpck_require__(40);
...
const { Octokit } = __nccwpck_require__(141);
const minimatch = (__nccwpck_require__(662).minimatch);
const src_process = __nccwpck_require__(932);
const path = __nccwpck_require__(547);
...
async function main() {
    ...
    const readOrgToken = src_process.env["INPUT_READ_ORG_SCOPED_TOKEN"];
    ...
    let prNumber;
    if (src_process.env["INPUT_BRANCH"] && src_process.env["INPUT_BRANCH"] !== "") {
        prNumber = await getNewestPRNumberByBranch(octokit, src_process.env["INPUT_BRANCH"], repo.data);
    } else if (src_process.env["INPUT_PR_NUMBER"] && src_process.env["INPUT_PR_NUMBER"] !== "") {
    ...
    if (src_process.env["INPUT_LIMIT_ORG_TEAMS_TO_CODEOWNERS_FILE"] === "true") {
